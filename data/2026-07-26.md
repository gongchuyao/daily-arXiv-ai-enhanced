...
### [5] [Group Chunks in Model Theory and Algebraic Geometry](https://arxiv.org/abs/2607.20824)
*Ronan O'Gorman*
...
### [6] [Prescribed extension spectra of mock automorphisms over finite fields](https://arxiv.org/abs/2607.20829)
...
### [7] [Absolute minimum of a height associated to a semipositive adelic line bundle](https://arxiv.org/abs/2607.20878)
...
### [8] [An Explicit Characteristic-$2$ Counterexample to the Separable Jacobian Conjecture](https://arxiv.org/abs/2607.20968)
*Irit Huq-Kuruvilla*
...
### [9] [Generic ordinarity for abelian coverings of the projective line](https://arxiv.org/abs/2607.21033)
*Régis Blache*
...
### [10] [Quantum index, Arnold-Rokhlin surfaces, and real enumerative geometry](https://arxiv.org/abs/2607.21251)
...
### [11] [New conjectures on multiplicities of tensor eigenvalues](https://arxiv.org/abs/2607.21422)
...
### [12] [The restricted Hitchin map of wobbly vector bundles](https://arxiv.org/abs/2607.21457)
*Clemens Nollau*
...
### [13] [Generic degrees of real polynomial Keller maps with non-dense image](https://arxiv.org/abs/2607.21572)
*Piotr Migus*
...
### [14] [A Mixed Discrete Cosserat Rod Formulation](https://arxiv.org/abs/2607.21164)
...
### [15] [Convergence and mixed-precision preconditioning for the naive Jacobi eigenvalue algorithm](https://arxiv.org/abs/2607.20749)
...
### [16] [A virtual element method for Darcy's problem coupled with a heat equation](https://arxiv.org/abs/2607.20755)
...
### [17] [Hierarchical Log-Gaussian Relaxation on a Fixed D3Q125 Velocity Set](https://arxiv.org/abs/2607.20846)
*Bjørn Wu*
...
### [18] [High-Order Exponential Integrators with Improved Uniform Accuracy for Charged-Particle in a Perpendicular Strong Magnetic Field](https://arxiv.org/abs/2607.21096)
...
### [19] [A stability-preserving polytopal discontinuous Galerkin method for the Fisher-Kolmogorov model with applications to neurodegenerative diseases](https://arxiv.org/abs/2607.21108)
...
### [20] [A Damped SWIFT Method for European Option Pricing: Coefficients Decay, Truncation, and Error Analysis](https://arxiv.org/abs/2607.21109)
...
### [21] [A Hyper-Reduced Neural Network-Augmented Semi-smooth Newton Method for Nonlinear Parametric Variational Inequalities](https://arxiv.org/abs/2607.21242)
...
### [22] [An unfitted boundary algebraic equation method with Calderón preconditioning for 2D Stokes flow in irregular geometry](https://arxiv.org/abs/2607.21295)
...
### [23] [Adaptive Non-Linear Partition of Unity Methods for Scattered Data Interpolation with Discontinuities](https://arxiv.org/abs/2607.21287)
...
### [24] [On the Approximation of the Unitary Operator Group Associated with a Rotation Matrix and Its Applications to Abstract Hyperbolic Equations](https://arxiv.org/abs/2607.21293)
...
### [25] [3D Uncertainty Quantification for the Photo-Acoustic Tomography](https://arxiv.org/abs/2607.21373)
...
### [26] [Jordan algebras, hemiplex numbers, and the Cholesky decomposition of arbitrary symmetric matrices](https://arxiv.org/abs/2607.21383)
...
### [27] [First-Order Analysis of Optimization in Uniformly Convex Metric Spaces: Directional Subderivatives and Basic Descent](https://arxiv.org/abs/2607.20677)
...
### [28] [Rule-Induced Behavior of Fuzzy Scalar Objective Functions for Reliable Multi-Criteria Decision Making](https://arxiv.org/abs/2607.20731)
*Olaf Frommann*
...
### [29] [A Safeguarded Projected-Gradient Framework for Complementarity-Constrained Least-Squares Problems](https://arxiv.org/abs/2607.20786)
...
### [30] [Mean field and N-agent games for optimal relative consumption-investment with jump risk and common noise](https://arxiv.org/abs/2607.20845)
...
### [31] [Structure-Preserving Spectral Dynamic Programming on Compact Lie Groups](https://arxiv.org/abs/2607.20854)
...
### [32] [Implicit Primal-Dual Guarantees in Unconstrained First-Order Minimization](https://arxiv.org/abs/2607.20875)
...
### [33] [Learning to recover: Adaptive local branching with reinforcement learning for log-truck routing and scheduling under disruptions](https://arxiv.org/abs/2607.20901)
...
### [34] [Boundary control and periodic trajectories of semilinear Euler equations with application to hydrogen transport](https://arxiv.org/abs/2607.20948)
...
### [35] [Dynamic Cloud Service-Capacity Deployment with Costly Response Readiness](https://arxiv.org/abs/2607.20961)
...
### [37] [Stabilization of 1D Linear Hyperbolic Balance Laws by Integral Difference Control and Application to Networks Stabilization](https://arxiv.org/abs/2607.21060)
...
### [38] [Exact ensemble controllability for neural differential equations via neural interpolation](https://arxiv.org/abs/2607.21112)
*Martin Gugat*
...
### [39] [A Gaussian smoothing-based zeroth-order method for Goldstein second-order stationarity](https://arxiv.org/abs/2607.21258)
...
### [40] [Fokker-Planck-Kolmogorov inclusions of the mean field type](https://arxiv.org/abs/2607.21297)
*Yurii Averboukh*
...
### [41] [Decomposing a Multi-Scale Optimization Framework for Grid-Integrated Electrolysis using Aggregate-Informed Benders](https://arxiv.org/abs/2607.21440)
...
### [42] [Climate-resilient electric vehicle charging infrastructure for sustainable cities: An interpretable causal-ensemble framework for preventive maintenance and low-carbon mobility](https://arxiv.org/abs/2607.21444)
...
### [43] [Asymptotic Analysis of Empirical Dynamic Programming in Infinite-Horizon Stochastic Optimal Control](https://arxiv.org/abs/2607.21520)
...
### [44] [Barzilai-Borwein Fails Superlinear Convergence on an Open Set of Quadratics for Every Dimension $n\geq 4$](https://arxiv.org/abs/2607.21579)
...
### [45] [On the Spatially Homogeneous Boltzmann Equation with Mass Exchange](https://arxiv.org/abs/2607.20684)
...
### [46] [Several counterexamples to kinetic Schauder estimates](https://arxiv.org/abs/2607.20682)
...
### [47] [Quasilinear equations with exponential growth for Hörmander $q$-sub-Laplacians on stratified Lie groups](https://arxiv.org/abs/2607.20685)
...
### [48] [Pointwise mean-value formulas with quantitative remainder for higher-order Poisson equations](https://arxiv.org/abs/2607.20776)
...
### [49] [Conditional scattering criteria for cylindrical threshold dynamics of the three-dimensional focusing energy-critical Schrödinger equation](https://arxiv.org/abs/2607.20809)
...
### [50] [Well-posedness of the mean field game master equation on Carnot tori](https://arxiv.org/abs/2607.20851)
...
### [51] [Harnack inequality for double-phase functionals with Muckenhoupt-type growth functions](https://arxiv.org/abs/2607.20855)
...
### [52] [Upper bound for the first $p$-Steklov eigenvalue in $\mathbb{R}^n$](https://arxiv.org/abs/2607.20865)
*Lili Wang,Tao Wang*
...
### [53] [On the well-posedness of porous medium equations on general metric measure spaces](https://arxiv.org/abs/2607.20894)
*Diwen Chang*
...
### [54] [An inverse coefficient problem for a semilinear wave equation by the first order linearization](https://arxiv.org/abs/2607.20949)
*Yuxiang He,Shuai Lu*
...
### [55] [Liouville Rigidity for Real and Complex Degenerate Hessian Equations](https://arxiv.org/abs/2607.21024)
...
### [56] [The mean-field limit of non-exchangeable particle systems with non-conservative dynamics and adaptive weights](https://arxiv.org/abs/2607.21110)
*Katarzyna Ryszewska*
...
### [57] [Rigidity of weak solutions for anisotropic N-Laplacian equation with Neumann or Robin boundary condition](https://arxiv.org/abs/2607.21123)
...
### [58] [Bayesian optimization approach for tracking a moving target from far-field data in three dimensions](https://arxiv.org/abs/2607.21135)
...
### [59] [Global bifurcation for steady viscous roll waves on an incline](https://arxiv.org/abs/2607.21142)
...
### [60] [Global existence and boundedness for a degenerate chemotaxis system with indirect signal production via minimizing movement schemes](https://arxiv.org/abs/2607.21211)
...
### [61] [Neutral curves and traveling waves in plane Poiseuille flow](https://arxiv.org/abs/2607.21265)
...
### [62] [An $L^p$-theory for global weak solutions to the Navier-Stokes equations in exterior domains](https://arxiv.org/abs/2607.21282)
*Filippo Palma*
...
### [63] [Magnetic relaxation for the MHD equations via the stable manifold method](https://arxiv.org/abs/2607.21328)
...
### [64] [Double screening in the training dynamics of variational physics-informed neural networks for heterogeneous coupled parabolic systems](https://arxiv.org/abs/2607.21352)
...
### [65] [A free boundary problem driven by boundary distance in the coincidence set](https://arxiv.org/abs/2607.21355)
...
### [66] [Sharp One-bubble Critical-Point Stability and Global Compactness for the Sobolev Trace Inequality](https://arxiv.org/abs/2607.21429)
*Bao Yu,Yang Zhou*
...
### [67] [Evolution of viscous vortex filaments and soliton-type propagation](https://arxiv.org/abs/2607.21439)
...
### [68] [Critical GJMS Equations on $\mathbb{H}^n \times \mathbb{S}^m$](https://arxiv.org/abs/2607.21451)
...
### [69] [Eigenfunctions, free boundaries, and time-frequency localization](https://arxiv.org/abs/2607.21590)
*João P. G. Ramos*
...
### [70] [A One-Dimensional Integral Equation for a Porous Horizontal Disc under Water Waves](https://arxiv.org/abs/2607.21102)
...
### [71] [Mixing Performance of Toroidal Ring Mixers: Effects of Flow Rate Ratios and Geometric Asymmetry](https://arxiv.org/abs/2607.20841)
...
### [72] [Fractal Scaling of Moffatt Vortices in Triangular Cavity Flow](https://arxiv.org/abs/2607.20976)
...
### [73] [Effect of free-stream turbulence on a moderate adverse pressure gradient turbulent boundary layer developing over an airfoil](https://arxiv.org/abs/2607.21047)
...
### [74] [A physics-assisted deep neural network-based closure framework for velocity gradient dynamics in compressible flows with vibrational non-equilibrium](https://arxiv.org/abs/2607.21152)
...
### [75] [A general synthetic iterative solver for axisymmetric rarefied gas and electrostatic charged-particle flows](https://arxiv.org/abs/2607.21277)
*Yifan Wen,Lei Wu*
...
### [76] [DataPrep-Bench: Benchmarking LLMs as Training Data Preparators](https://arxiv.org/abs/2607.20465)
...
### [77] [PhantomFill: When the Form Demands an Answer, Language Models Invent One](https://arxiv.org/abs/2607.20492)
*Rana Muhammad Usman*
...
### [78] [The Active Ingredient in Muon's Grokking](https://arxiv.org/abs/2607.20512)
*Yufeng Wang*
...
### [79] [Scaling Closed-Loop Feature Channel Configuration with LLMs](https://arxiv.org/abs/2607.20516)
...
### [80] [Generative Bayesian Filtering for State Estimation](https://arxiv.org/abs/2607.20521)
...
### [82] [CLOE: Christoffel Loss Autoencoder for Anomaly Detection](https://arxiv.org/abs/2607.20530)
...
### [84] [Fisher Widths: Local Learning Geometry and Anisotropic Recovery](https://arxiv.org/abs/2607.20578)
*Vu Khac Ky*
...
### [85] [When Does Recurrence Become an Algorithm? Convergence Selection in Weight-Tied Looped Transformers](https://arxiv.org/abs/2607.20594)
...
### [86] [Do Active SAE Feature Planes Carry More Holonomy? A Preregistered Reversal in Gemma](https://arxiv.org/abs/2607.20522)
*Larry Richards*
...
### [87] [Smooth Neural Point Processes via B-Splines](https://arxiv.org/abs/2607.21098)
...
### [88] [TwistedMerge: Certified Higher-Order Diagnostics and Abstention for Model Merging](https://arxiv.org/abs/2607.20887)
*Ting Gong,Shitan Xu*
...
### [90] [Hilbert Operator for Progressive Encoding (HOPE): A Mathematical Framework for Deconstructing Learned Representations in Deep Networks](https://arxiv.org/abs/2607.21366)
...
### [91] [Semantic-Aware Task Clustering for Constructive and Cooperative Multi-Tasking](https://arxiv.org/abs/2607.21426)
...
### [93] [Finite-Sample Coverage Audits for High-Recall Candidate Generation: Certification and Learning-Theoretic Design](https://arxiv.org/abs/2607.21480)
...
### [94] [Grounding Investor Views: Neural Predicates in the Black-Litterman Model](https://arxiv.org/abs/2607.20533)
*Marcos Florencio*
...
### [95] [Zero-Flow Two-Sample Tests](https://arxiv.org/abs/2607.21542)
...
### [96] [A Graph Neural Network approach to zero-shot Digital Twins](https://arxiv.org/abs/2607.20535)
...
### [97] [ReliableTableQA:How Much Supervision Does Reliability Annotation Need?](https://arxiv.org/abs/2607.20537)
...
### [98] [Codec-Gauge: Learning Compression-Friendly Gauges for Transformer KV Caches](https://arxiv.org/abs/2607.20538)
...
### [99] [Leveraging Biokinetic Knowledge Priors for Data-Scarce Bioprocess Modeling](https://arxiv.org/abs/2607.20539)
...
### [100] [From Atoms to Entropy: Optimal Noise Allocation for Diffusion Training in the Convex Regime](https://arxiv.org/abs/2607.20540)
...
### [101] [HypNO: A Graph-Based Neural Operator with Physics-Informed Message Passing for Hyperbolic Conservation Laws](https://arxiv.org/abs/2607.20541)
...
### [102] [Improving Access to Essential Medicines via Decision-Aware Machine Learning](https://arxiv.org/abs/2607.20542)
...
### [104] [When RLVR Shrinks the Reasoning Boundary: Diagnosing Pass@k Inversion](https://arxiv.org/abs/2607.20543)
*Todd Zhou*
...
### [105] [End-to-End Learning of Safe Optimal Feedback Control in High Dimensions with Control Barrier Function Layers](https://arxiv.org/abs/2607.20674)
...
### [106] [Conflict Resolution under Degraded Surveillance in Air Corridors Using Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2607.20547)
...
### [107] [SOAP, Muon, and Beyond: Pushing LLM Pretraining Scales](https://arxiv.org/abs/2607.20548)
...
### [108] [SevDiff: Severity-Conditioned Diffusion for Long-Tail Conflict Trajectory Generation](https://arxiv.org/abs/2607.20549)
...
### [109] [Beyond SBDD: Geometric Deep Learning in Polypharmacology and Multi-target Drug Design](https://arxiv.org/abs/2607.20550)
...
### [110] [SenCos-GEM: SENet-Calibrated and Law-of-Cosines-Constrained Geometry-Enhanced Molecular Representation for Property Prediction](https://arxiv.org/abs/2607.20551)
...
### [112] [Monkey King Bang: A Unified Scientific Multimodal Foundation Model](https://arxiv.org/abs/2607.20557)
...
### [113] [StabilityBench: Benchmarking Instability in LLMs](https://arxiv.org/abs/2607.20558)
...
### [114] [Joint Utilization of Geospatial and census proxies for Autoencoder-Assisted Downscaling (JUGAAD) of socioeconomic indicators in India](https://arxiv.org/abs/2607.20559)
...
### [115] [Chronofy: A Temporal-Logical Decay Architecture for Information Validity in Time-Aware Retrieval-Augmented Generation](https://arxiv.org/abs/2607.20560)
...
### [116] [CT-Merging: Consensus Directions and Task-Level Scaling for LoRA Adapter Merging](https://arxiv.org/abs/2607.20561)
...
### [117] [AI-Driven Surrogate Models for Predicting Electrode-Scale Discharge Behavior in Lithium-Ion Batteries](https://arxiv.org/abs/2607.20577)
...
### [118] [Bayesian uncertainty estimation improves clinical decision making in medical AI agents](https://arxiv.org/abs/2607.20582)
...
### [119] [Exact ReLU realization of affine one-dimensional refinement iterates via residual memory and offset frames](https://arxiv.org/abs/2607.20586)
...
### [120] [Detecting Neural Network Failures through Spectral Analysis of Internal Activations](https://arxiv.org/abs/2607.20590)
*Arunan J*
...
### [121] [STeMP: Spatio-Temporal Modelling Protocol](https://arxiv.org/abs/2607.20592)
...
### [122] [Are Single-Token Sparse Autoencoder Features Causally Necessary? Layer-Depth and SAE-Family Effects](https://arxiv.org/abs/2607.20596)
...
### [123] [One Round Is All You Need: Analytic Federated Learning for Task-Heterogeneous Multi-Label Medical Image Classification](https://arxiv.org/abs/2607.20641)
...
### [124] [Scaling Interpretable Transformers with Parity Bottleneck Layers](https://arxiv.org/abs/2607.20652)
...
### [125] [SalesLoop: Reinforcement Learning from Performance Feedback for Sales Lead Ranking](https://arxiv.org/abs/2607.20655)
*Chenyu Zhang*
...
### [126] [Adaptive Multi-Horizon Reinforcement Learning](https://arxiv.org/abs/2607.20656)
...
### [146] [Information-Theoretically Secure Aggregation for Lightweight Federated Learning: Resilient to Dropouts and Adversaries](https://arxiv.org/abs/2607.20890)
...
### [147] [HierarchicalDAEW: Domain-Aware Edge-Weighted Graph Convolution with Evidential Uncertainty for Multi-Section Spatial Gene Expression Prediction from H&E Histology](https://arxiv.org/abs/2607.20896)
...
### [148] [Multi-turn RL with Structural and Performance Aware Rewards for CUDA Kernel Generation](https://arxiv.org/abs/2607.20908)
...
### [149] [Three-Pronged Spectral Control for Federated Parameter Efficient Fine Tuning](https://arxiv.org/abs/2607.20914)
...
### [150] [Best-of-Evidence: Best-of-N Selection under Partial Verification](https://arxiv.org/abs/2607.20950)
...
### [151] [The Weight of Silence: A Causal Case for Weights Over the Scratchpad in Latent Chess Reasoning](https://arxiv.org/abs/2607.20952)
*Ishan S. Kshirsagar*
...
### [155] [Counterfactual Explainability Framework With CycleGAN And Counterfactual-Classifier Alignnment Score for Retinal Disease Classification](https://arxiv.org/abs/2607.21068)
...
### [156] [From Evaluation to Optimisation: Hierarchy-Aware Training Signals for CWE Prediction in Python](https://arxiv.org/abs/2607.21069)
...
### [157] [Spectral Transformation for Layer-wise Global Rank Discovery in Federated LoRA for Vision Transformers](https://arxiv.org/abs/2607.21074)
...
### [162] [TOUR: A Trajectory-Level Unlearning Benchmark for Offline Reinforcement Learning](https://arxiv.org/abs/2607.21111)
...
### [163] [GlucoTune: A Unified Framework for Blood Glucose Preprocessing, Forecasting, and Benchmarking in Diabetes](https://arxiv.org/abs/2607.21117)
...
### [164] [Relative Value Learning](https://arxiv.org/abs/2607.21120)
...
### [165] [Demographically-Informed Heat-Mortality Risk Curves via Risk Graph Neural Networks](https://arxiv.org/abs/2607.21131)
...
### [166] [Agree on the Model, Verify the Inference: GKR Protocols for HND-Based Transformer Inference](https://arxiv.org/abs/2607.21162)
...
### [167] [Automated Synthesis and Adversarial Validation of Executable Causal Research Pipelines](https://arxiv.org/abs/2607.21173)
...
### [168] [Filter Learning for Subgraphs: Algebras and Performance Risk Bounds](https://arxiv.org/abs/2607.21263)
...
### [169] [The Dark Room in the Reward Channel: Dense Prediction Rewards Collapse GRPO-Trained LLM Agents -- and What Actually Works](https://arxiv.org/abs/2607.21273)
*Yu Wang*
...
### [170] [Multi-Task Learning for Heterogeneous Prediction from Video Game State with Transfer Learning](https://arxiv.org/abs/2607.21290)
...
### [171] [AI Assistants Overassist](https://arxiv.org/abs/2607.21306)
...
### [172] [M$^3$-Gen: Interpretable Multimodal Generation of Gene Expression Profiles Using Clinical and Imaging Data](https://arxiv.org/abs/2607.21343)
...
### [173] [How Many Bits Can an Adapter Write? Measuring the Capacity and Memorization of Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2607.21351)
...
### [174] [Gradient Concentration, Not Weight Saliency, Explains Representation-Level Class Unlearning](https://arxiv.org/abs/2607.21353)
...
### [175] [Emergent Misalignment Recruits a Pre-existing Persona Subspace](https://arxiv.org/abs/2607.21356)
...
### [176] [Mean-to-Score Discrete Diffusion: Posterior-Mean Denoisers for Score Entropy](https://arxiv.org/abs/2607.21372)
...
### [177] [A Diffusion-Model Subpopulation Digital Twin for Mobile Health Deployment: A Case Study on the HeartSteps Intervention](https://arxiv.org/abs/2607.21403)
...
### [181] [Error Certificates for KV-Cache Eviction via Randomized Design](https://arxiv.org/abs/2607.21475)
*Peng Xie*
...
### [183] [Windowed-MTP: Removing the Full-Context Draft-KV Tax at Million-Token Context](https://arxiv.org/abs/2607.21535)
...
### [184] [X$^3$-OPD: Distilling Reasoning into Large Audio-Language Models via On-Policy Alignment](https://arxiv.org/abs/2607.21550)
...
### [185] [Graph Learning on Ensembles of Cyclic Peptides: An Investigation of Molecular Ensemble Modeling](https://arxiv.org/abs/2607.21561)
...
### [186] [Beyond Sufficiency: Time Series Explanation with Counterfactual Necessity](https://arxiv.org/abs/2607.21573)
...
### [187] [Expanding Flow Maps](https://arxiv.org/abs/2607.21585)
...
### [188] [SPECTRA: State-Space Exogenous Context and Temporal-Frequency Resolution Architecture for Probabilistic Energy Forecasting](https://arxiv.org/abs/2607.20587)
...
### [189] [Automatic knot selection in smooth additive models](https://arxiv.org/abs/2607.21083)
...
### [190] [Transformer-based Diffusion models for Hydrological Time Series Probabilistic Imputation and Forecasting](https://arxiv.org/abs/2607.21200)
