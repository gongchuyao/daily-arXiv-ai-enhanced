...
### [1] [Lectures on Existence and Regularity of Anisotropic Minimal Surfaces](https://arxiv.org/abs/2608.10275)
*Antonio De Rosa*
...
### [2] [Asymptotic stability of the degree-one vortex in the abelian Yang-Mills-Higgs model: Spectral Theory and Numerics](https://arxiv.org/abs/2608.10608)
...
### [3] [Nonradial stable solutions near the Joseph--Lundgren threshold](https://arxiv.org/abs/2608.10501)
...
### [4] [Asymptotic stability of the degree-one vortex in the abelian Yang-Mills-Higgs model: Linear Theory](https://arxiv.org/abs/2608.10609)
*Jonas Luhrmann,José M. Palacios,Fabio Pusateri,Wilhelm Schlag,Sohrab Shahshahani*
...
### [5] [Generalised higher order vectorial $\infty$-eigenvalue problems](https://arxiv.org/abs/2608.10531)
...
### [6] [Asymptotic stability of the degree-one vortex in the abelian Yang-Mills-Higgs model](https://arxiv.org/abs/2608.10610)
*Jonas Luhrmann,José M. Palacios,Fabio Pusateri,Wilhelm Schlag,Sohrab Shahshahani*
...
### [7] [On the large-time behavior of strong solutions to the generalized compressible Navier-Stokes-Korteweg system in 2D and 3D for arbitrarily large initial data](https://arxiv.org/abs/2608.10546)
...
### [8] [Formation of Implosion Singularities in 3D Compressible Navier-Stokes-Korteweg Equation](https://arxiv.org/abs/2608.10554)
...
### [9] [Couette-Taylor instabilities in the small gap regime: the very counter-rotating case](https://arxiv.org/abs/2608.10951)
...
### [10] [Morrey's Derivation of Hydrodynamics from Statistical Mechanics: A Modern Exposition](https://arxiv.org/abs/2608.10612)
*Yuyang Wang*
...
### [11] [Classification of positive entire solutions of the CR Yamabe equation on the Heisenberg group](https://arxiv.org/abs/2608.10642)
*Jungang Li*
...
### [12] [An entropy approach to doubly nonlinear parabolic obstacle problems](https://arxiv.org/abs/2608.10666)
*Ruoyang Liu*
...
### [13] [On a multi-phase Stefan problem in the half-line with different boundary conditions at the fixed boundary](https://arxiv.org/abs/2608.10732)
*E. Yu. Panov*
...
### [14] [Decay and regularity properties for the dispersion generalized Benjamin-Ono equation](https://arxiv.org/abs/2608.10767)
...
### [15] [Exterior Dirichlet Problems for Hessian Quotient Equations of Mixed Type](https://arxiv.org/abs/2608.10834)
*Yu Lei,Zhisu Li*
...
### [16] [Entropy Production and Reversibility Criteria for Stochastic Evolution Equations](https://arxiv.org/abs/2608.11059)
...
### [17] [Harnack-type inequalities and traveling waves for non-cooperative nonlocal diffusion systems](https://arxiv.org/abs/2608.11107)
...
### [18] [Sharp Beckner's Inequalities for Axially Symmetric Functions on $\mathbb{S}^N$](https://arxiv.org/abs/2608.11126)
...
### [19] [A reaction-diffusion system with nonconstant diffusion coefficients: exact and numerical solutions](https://arxiv.org/abs/2608.11172)
...
### [20] [Lions' Maximal Regularity Problem for Divergence-Form Differential Operators: Failure at the $\frac{1}{2}$-Hölder Endpoint](https://arxiv.org/abs/2608.11194)
*Lukas Niebel*
...
### [21] [Polyhedral Outer-Approximations for MISOCP: Geometry and Cutting Planes](https://arxiv.org/abs/2608.10055)
*Yongzheng Dai*
...
### [22] [Thread Scaling of Hexaly on the TDVRPTW across Two Model Encodings. An Experimental Report: External-Function Serialization, Slice-Count Choice, and the Time-Sliced Thread Ladder](https://arxiv.org/abs/2608.10079)
*Florian Rascoussier*
...
### [23] [A lower bound for stepsize-based acceleration of gradient descent](https://arxiv.org/abs/2608.10418)
...
### [24] [A New Approach for Feedback Stabilization and its Application for Data-Driven Control of Polynomial Systems](https://arxiv.org/abs/2608.10158)
...
### [25] [An Optimal Energy Production Problem with Energy Source Switching and Load Following Nuclear Power Plants](https://arxiv.org/abs/2608.10197)
...
### [26] [Towards Co-Designed Event-Triggered Extremum Seeking](https://arxiv.org/abs/2608.10246)
...
### [27] [Continuous-Time Covariance Steering with Common Free-Final Time: Finite-Horizon Solutions and Infinite-Horizon Limits](https://arxiv.org/abs/2608.10267)
...
### [28] [Kullback-Leibler Mirror-Prox for Measure-Valued Variational Inequalities and Mean-Field Equilibria](https://arxiv.org/abs/2608.10293)
...
### [29] [Attainment Boundaries and Escape Rates in Asymptotically Conic Optimization](https://arxiv.org/abs/2608.10341)
*Vinh Nguyen*
...
### [30] [Submillisecond Sequential Convex Optimization for Powered Landing via Dynamics Condensation and xPIPG](https://arxiv.org/abs/2608.10395)
...
### [31] [Indefinite Stochastic Linear-Quadratic Optimal Control Problem for a Markov Regime-Switching Model](https://arxiv.org/abs/2608.10597)
...
### [32] [Randomization and Performance Improvement for Integer Optimal Control with Total Variation Regularization](https://arxiv.org/abs/2608.10624)
...
### [33] [Robust Unit Commitment in District Heating Networks: Chance-Constrained and CVaR Optimization Under Demand Uncertainty](https://arxiv.org/abs/2608.10899)
...
### [34] [Robust Patrol in a Dispersed Environment](https://arxiv.org/abs/2608.10935)
...
### [35] [Threshold Structure of Optimal Policies in Restart POMDPs](https://arxiv.org/abs/2608.10936)
...
### [36] [Prescribed-performance position tracking for infinite-dimensional passive systems](https://arxiv.org/abs/2608.10940)
...
### [37] [DD-suite: A cross-platform package to build Decision Diagrams for optimization purposes](https://arxiv.org/abs/2608.10957)
...
### [38] [Gromov-Wasserstein Quantization and Clustering: Structure, Rates, and Algorithms](https://arxiv.org/abs/2608.11016)
...
### [39] [Integrated Surgical Scheduling with Weekend Bed Occupancy Management: A Column Generation Approach](https://arxiv.org/abs/2608.11018)
...
### [40] [Certificate-based Synthesis of Coordinated Droop Control for Heterogeneous Radial Distribution Networks](https://arxiv.org/abs/2608.11141)
...
### [41] [A Volumetrically Stabilized Mixed Formulation of the Finite Element Immersed Boundary Method for Fluid Structure Interaction with Fully Incompressible Hyperelastic Solids](https://arxiv.org/abs/2608.10217)
...
### [42] [An efficient and robust fifth-order HWENO scheme with gradient reconstruction for compressible Navier--Stokes equations](https://arxiv.org/abs/2608.10569)
...
### [48] [A numerical approach for solving the time-Fractional Mobile-Immobile Transport Equation](https://arxiv.org/abs/2608.10607)
*Sandip Maji*
...
### [49] [Uniform discrete Poincaré inequalities for Hybrid High-Order differential forms on polyhedral meshes](https://arxiv.org/abs/2608.10713)
*Silvano Pitassi*
...
### [50] [Successive Schur-Riesz Analysis for Approximation](https://arxiv.org/abs/2608.10757)
...
### [51] [A High-Order Galerkin Scheme for the Decoupled Potential Integral Equations](https://arxiv.org/abs/2608.10799)
...
### [52] [Locking analysis and high-order locking-free finite element method for three-dimensional electroporoelasticity equations](https://arxiv.org/abs/2608.10830)
...
### [53] [Adaptive Time-Stepping Euler--Maruyama Scheme for SDEs with Non-Globally Lipschitz Coefficients: Uniform Convergence, Stability and Ergodicity](https://arxiv.org/abs/2608.10855)
...
### [54] [Diffusion Quasi-Monte Carlo](https://arxiv.org/abs/2608.11055)
...
### [55] [Randomized Tucker-Sketched GMRES](https://arxiv.org/abs/2608.11091)
...
### [56] [How different is rational approximation from piecewise polynomial approximation?](https://arxiv.org/abs/2608.11120)
*Daan Huybrechs*
...
### [57] [Obstructions for codimension one multiple fibers of Lagrangian and Calabi--Yau fibrations](https://arxiv.org/abs/2608.10102)
...
### [58] [A criterion for associated bundles and the weak Beauville--Bogomolov decomposition](https://arxiv.org/abs/2608.10219)
*Yang Zhang*
...
### [59] [Introduction to Universal Equations and Characteristic-free Resolution](https://arxiv.org/abs/2608.10272)
*Yi Hu*
...
### [60] [On the decomposition theorem for forgetful maps between moduli spaces of stable pointed curves](https://arxiv.org/abs/2608.10461)
*Hao Zhang*
...
### [61] [Finite quotients of sousperfectoid adic spaces need not be adic](https://arxiv.org/abs/2608.10481)
...
### [62] [Kronecker Products of Symmetric Persistent Tensors](https://arxiv.org/abs/2608.11182)
*Masoud Gharahi*
...
### [63] [Finite monodromy groups in degenerating families and the stability degree of curves](https://arxiv.org/abs/2608.10742)
*Séverin Philip*
...
### [64] [Moderate and rapid-decay nearby cycles for holonomic D-modules](https://arxiv.org/abs/2608.10782)
*Claude Sabbah*
...
### [65] [Poincaré à la Makdisi](https://arxiv.org/abs/2608.10815)
*Nicolas Mascot*
...
### [66] [An affine local criterion for toric projective space bundles](https://arxiv.org/abs/2608.10849)
...
### [67] [Log Calabi-Yau compactifications of $SL(2,\mathbb{C})$ character varieties](https://arxiv.org/abs/2608.10918)
...
### [68] [$\mathbb{A}^1$-fibration in algebraic geometry and $\mathbb{A}^1$-homotopy type](https://arxiv.org/abs/2608.10966)
...
### [69] [Invisible singularities in complex algebraic geometry](https://arxiv.org/abs/2608.10973)
...
### [70] [Type C Richardson Boundaries and Newton-Okounkov Degenerations of Odd-Dimensional Projective Space](https://arxiv.org/abs/2608.11109)
*Zhaoyang Liu*
...
### [71] [Equilibrium Distributions for Strongly Nonlinear Many-Body Systems](https://arxiv.org/abs/2608.10352)
...
### [72] [Anomalous current fluctuations in the stochastic XNOR hopping model](https://arxiv.org/abs/2608.10536)
*Balázs Pozsgay*
...
### [73] [Steady-state phase transition in one-dimensional hybrid contact process](https://arxiv.org/abs/2608.10948)
...
### [74] [Experimental Kuramoto Platform](https://arxiv.org/abs/2608.04119)
...
### [75] [Jamming transition in an active exclusion process](https://arxiv.org/abs/2608.11041)
...
### [76] [Exact Expressions of Entropy for Classical Non-interacting Many-body Systems](https://arxiv.org/abs/2608.11104)
...
### [77] [Exact First-Passage Time Response Theory from Steady-State Response](https://arxiv.org/abs/2608.11202)
...
### [78] [SA-AI (Spalart-Allmaras with Autogenous Inception) Technical Summary](https://arxiv.org/abs/2608.10303)
*Qiqi Wang*
...
### [79] [Wind-Informed Rapid Flight-Planning in Complex Urban Topologies via Machine Learning and Experimental Validation](https://arxiv.org/abs/2608.10309)
...
### [80] [Low-dimensional structure and online tracking of POD subspaces on the Grassmann manifold: application to flow around an airfoil](https://arxiv.org/abs/2608.10498)
...
### [81] [Deep reinforcement learning for separation control in turbulent wind-tunnel flow](https://arxiv.org/abs/2608.10829)
...
### [82] [Inelastic spreading of viscoelastic drops](https://arxiv.org/abs/2608.10851)
...
### [84] [Transformer Geometry Observatory TGO-IV: Developmental Topology Observatory](https://arxiv.org/abs/2608.09997)
...
### [85] [Uncertainty-Aware Ensemble Deep Randomized Neural Networks for Classification](https://arxiv.org/abs/2608.10007)
...
### [87] [CurveFP: Rational-Radix Logarithmic Datatypes with Closed Products for Language Models](https://arxiv.org/abs/2608.10010)
*Ye Qiao*
...
### [90] [Optimistic Rates for Multiclass PAC Learning](https://arxiv.org/abs/2608.10869)
...
### [92] [Efficient Hypergradient Descent for Inverse Reinforcement Learning](https://arxiv.org/abs/2608.11052)
...
### [94] [UserToolBench: A User-Profile-Hidden Benchmark for Personalized Decision Making in Tool-Use LLMs](https://arxiv.org/abs/2608.10042)
...
### [95] [Finding the Signal in the Spam: Jointly Learning Rewards and Worker Reliability from Pairwise Comparisons](https://arxiv.org/abs/2608.10045)
...
### [96] [Detecting Soft Skills in ML Engineering Roles CVs](https://arxiv.org/abs/2608.10046)
...
### [97] [Physics-Informed Machine Learning in Prognostics and Health Management: A Systematic Literature Review](https://arxiv.org/abs/2608.10047)
...
### [98] [Observational Policy Ranking for SMB Financial Guidance from Multi-Action Accounting Logs](https://arxiv.org/abs/2608.10050)
...
### [99] [ChronoSSM: Training for Temporally Aware Representations in Autoregressive State Space Models](https://arxiv.org/abs/2608.10120)
...
### [100] [Procedural Fairness Failures in RLHF from Preference Averaging](https://arxiv.org/abs/2608.10126)
...
### [101] [SeFoRA: Sketch-Aggregated Federated Low-Rank Adaptation with Heterogeneous Client Ranks](https://arxiv.org/abs/2608.10144)
...
### [102] [The Evaluation Protocol Determines the Result: An Independent Reproduction of LeWorldModel on TwoRoom](https://arxiv.org/abs/2608.10145)
*Joyjeet Singh*
...
### [103] [REATS: LLM Reasoning-based Ensemble Learning for Adaptive Time Series Forecasting](https://arxiv.org/abs/2608.10149)
...
### [104] [Long-Time Trajectory Approximation via SA-NODEs: Model Predictive and Floquet Strategies](https://arxiv.org/abs/2608.10738)
...
### [145] [MoE Proxy Models for Low-Cost Failure Reproduction and Diagnosis in LLM RL Post-Training](https://arxiv.org/abs/2608.10823)
...
### [146] [TACTICL: Task-Aware Compression of Tabular ICL Models](https://arxiv.org/abs/2608.10837)
...
### [147] [Diffract: Spectral View of LLM Domain Adaptation](https://arxiv.org/abs/2608.10850)
...
### [148] [FiGuRO: Intrinsic Dimension Estimation for Multi-Modal Data](https://arxiv.org/abs/2608.10857)
...
### [149] [Can Bayesian Optimization Efficiently Find a Strong Single Expert in Neural Thickets?](https://arxiv.org/abs/2608.10867)
...
### [150] [Benchmarking Time Series Generation Methods for Privacy-Preserving Forecasting](https://arxiv.org/abs/2608.10891)
...
### [151] [Partially Observable Learning for Multi-Platform Dispatch Optimization](https://arxiv.org/abs/2608.10897)
...
### [152] [ReOrder-OPD:Reliability-Aware Prompt Ordering for On-Policy Distillation](https://arxiv.org/abs/2608.10905)
...
### [153] [Physics-informed Diffusion Generative Model for Time-Series Data Synthesis in Dynamic Systems](https://arxiv.org/abs/2608.10941)
...
### [154] [GARLIC: Graph Attention-based Relational Learning of Multivariate Time Series in Intensive Care](https://arxiv.org/abs/2608.10969)
...
### [155] [DEFT: Data-Efficient Frequency-domain Top-k Sampling via Inverse Discrete Fourier Transform for Spatiotemporal Dynamical Systems Modeling](https://arxiv.org/abs/2608.11019)
...
### [156] [Mapping and Measuring the Behavioral Evolution of Large Language Models](https://arxiv.org/abs/2608.11027)
...
### [157] [ReRound: Reconstructive Rounding to Resolve Midpoint Ambiguity in Calibration-Free LLM Quantization](https://arxiv.org/abs/2608.11045)
...
### [158] [Uncertainty-Aware Deep Learning for Genomics Applications: Insights from an Empirical Study](https://arxiv.org/abs/2608.11054)
...
### [159] [Batch Size or Negatives? A Selection Rule for Memory-Constrained Recommender Training](https://arxiv.org/abs/2608.11061)
...
### [160] [Cross-View Feature Matching: Survey, Benchmarking, and Foundation-Model Perspectives](https://arxiv.org/abs/2608.11093)
...
### [161] [Two-stage Odd Residual Flows for Mean-Preserving Probabilistic Time Series Forecasting](https://arxiv.org/abs/2608.11114)
...
### [162] [A Recommendation System Approach for Interference-Robust Sensor Subset Selection](https://arxiv.org/abs/2608.11143)
...
### [163] [DACRI: Decision-Aware Causal Intervention Ranking for Critical Supply Chains](https://arxiv.org/abs/2608.11154)
...
### [164] [Hierarchical Empirical-Bayes Naive Bayes: Minimax Smoothing and Calibration with AODE Extension](https://arxiv.org/abs/2608.11162)
...
### [165] [Beyond a Bag of Features: Set-Level Instability in Sparse Autoencoders](https://arxiv.org/abs/2608.11197)
...
### [166] [Generalized Master Stability of Heterogeneous Delay-Coupled Networks](https://arxiv.org/abs/2608.10076)
...
### [167] [Learning to Synchronize in Minimum Time](https://arxiv.org/abs/2608.10354)
*Kevin. P. O'Keeffe*
...
### [168] [Deciding When to Switch: E-Processes for Adaptive Minimax Training for Generative Adversarial Nets](https://arxiv.org/abs/2608.10096)
...
### [169] [Iterative Erasure Count Is Not an Affine-Invariant Concept Dimension](https://arxiv.org/abs/2608.10566)
...
### [170] [Spectral Embeddings of Degree-$α$ Laplacians in Random Dot Product Graphs](https://arxiv.org/abs/2608.10845)
*John Park,Ning Hao*
...
### [171] [Self-Normalized Inference for Constant-Stepsize Temporal-Difference Learning under Markovian Sampling](https://arxiv.org/abs/2608.10896)
...
### [172] [Conditional Independence Tests for Constraint-Based Causal Discovery: A Survey](https://arxiv.org/abs/2608.11156)
